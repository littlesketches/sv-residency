...
////////////////////////////////////
        ...
        async function buildExportCard(material = state.material, date = state.date.export){
            ...
            d3.select('#export-market-subheader').html(`of <strong>${helpers.numberFormatters.formatComma(thisMonthExport)} tonnes of ${state.material.toLowerCase()} exported</strong> in ${monthYear}. Individual countries are ranked (most to least) by total exports over the past three months`)
